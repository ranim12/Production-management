<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Operatrices_D4.aspx.cs" Inherits="WebApplication2.Operatrices_D4" %>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="Secteur_Liste" class="list-group-item list-group-item-action bg-light">Operatrices</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            <li class="nav-item active">
              <a class="nav-link" href="#">Ajouter un secteur<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#">Supprimer un secteur</a>
            </li>
      ...
      <asp:GridView ID="GridView1" Class="table table-striped table-bordered" runat="server" AutoGenerateColumns="False" DataKeyNames="Operatrices_ID" DataSourceID="SqlDataSource1">
          <Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PECACConnectionString %>" SelectCommand="SELECT * FROM [Operatrice_tbl] WHERE ([Secteur] = @Secteur)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="D4" Name="Secteur" Type="String" />
                </SelectParameters>
      </asp:SqlDataSource>
  </div>
</div>
